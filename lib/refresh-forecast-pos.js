...
/**
 * Pull live Open + On Hold POs from Acumatica so MySQL statuses stay current.
 * Forecast Coming PO still counts Open only (On Hold is excluded), same as Replenishment.
 */
