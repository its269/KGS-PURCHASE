...
function buildHowItWorks({
    ...
    if (hasSalesHistory) {
        ...
        steps.push({
            ...
            text: isMainWarehouseView
                ? `Branch replenishment total: ${formatUnits(mainWarehouseContext.totalBranchReplenishment)} units. Minus MAIN stock (${formatUnits(currentStock)}) and coming PO (${formatUnits(mainWarehouseContext.comingPO)}) = ${formatUnits(suggestedQty)} units to order from vendor.`
