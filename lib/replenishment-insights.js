...
function buildHowItWorks({
    ...
    steps.push({
        title: "Data sources",
        text: `Stock on hand comes from the inventory database for branch ${branchId}. Sales history comes from synced Acumatica sales records (last 90 days).${vendorId ? ` Vendor ${vendorId} is linked to this item for lead-time checks.` : ""}`,
    });
