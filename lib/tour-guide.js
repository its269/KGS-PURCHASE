    ...
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                body: "Set Last 3 Month Date and Last Year Same Quarter. Defaults match Last 3 Months Sales (May–August 2026) and last year same quarter (October–December 2025). Last year uses invoices when available, or older sales history if invoices were not imported.",
            },
            {
                target: "branch-filter",
                placement: "bottom",
            ...
            },
            {
                ...
                body: "Blue columns come from stock items. Amber columns are planning: enter Estimate Sales, Buffer Inventory, and Target Sales. For P.O, amount, and Net P.O update automatically.",
            },
        ],
    },
    {
